...
manager.register_room("foyer", Foyer(inventory))
manager.register_room("kitchen", Kitchen(inventory))
manager.register_room("living_room", LivingRoom(inventory))
manager.register_room("library", Library(inventory))
manager.register_room("dining_room", DiningRoom(inventory))
manager.register_room("wine_cellar", WineCellar(inventory))
manager.register_room("furnace_room", FurnaceRoom(inventory))
manager.register_room("secret_room", SecretRoom(inventory))
#manager.register_room("stairs", StairsRoom(inventory))
#manager.register_room("upstairs_stairs", UpstairsStairsRoom(inventory))
#manager.register_room("upstairs", UpstairsHallway(inventory))
manager.register_room("master", MasterBedroom(inventory))
manager.register_room("guest", GuestBedroom(inventory))
manager.register_room("childs", ChildsBedroom(inventory))
manager.register_room("bathroom", Bathroom(inventory))
